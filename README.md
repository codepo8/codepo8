...
- [[Video] How to debug web projects using the browser developer tools inside Visual Studio code](https://christianheilmann.com/2021/03/05/video-how-to-debug-web-projects-using-the-browser-developer-tools-inside-visual-studio-code/)
- [Syncing visual CSS changes in browser tools with source code using Workspaces](https://dev.to/codepo8/syncing-visual-css-changes-in-browser-tools-with-source-code-using-workspaces-26nb)
- [Syncing CSS changes in browser developer tools with Workspaces](https://christianheilmann.com/2021/03/02/syncing-css-changes-in-browser-developer-tools-with-workspaces/)
<!-- BLOG-POST-LIST:END -->
