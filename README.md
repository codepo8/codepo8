...
- [Using position: sticky to create persistent headers in long texts](https://dev.to/codepo8/using-position-sticky-to-create-persistent-headers-in-long-texts-8b8)
- [Using position: sticky to create persistent headers in long texts](https://christianheilmann.com/2021/02/09/using-position-sticky-to-create-persistent-headers-in-long-texts/)
<!-- BLOG-POST-LIST:END -->
