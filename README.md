...
- [New in 1.4.6: Using the DevTools Console inside Visual Studio Code and offline functionality](https://christianheilmann.com/2022/03/24/new-in-1-4-6-using-the-devtools-console-inside-visual-studio-code-and-offline-functionality/)
- [Running a dedicated local server for a VS Code debugging session using tasks](https://dev.to/codepo8/running-a-dedicated-local-server-for-a-vs-code-debugging-session-using-tasks-25ck)
- [Automatically starting a server when starting a debug session in VS Code](https://christianheilmann.com/2022/03/17/automatically-starting-a-server-when-starting-a-debug-session-in-vs-code/)
<!-- BLOG-POST-LIST:END -->
