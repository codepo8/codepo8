...
- [Quick tip: using flatMap&lpar;&rpar; to extract data from a huge set without any loop](https://dev.to/codepo8/quick-tip-using-flatmap-to-extract-data-from-a-huge-set-without-any-loop-3i7p)
