...
- [Quick browser Developer Tools tip: define and test interaction states in CSS using state simulation](https://christianheilmann.com/2021/11/07/quick-browser-developer-tools-tip-define-and-test-interaction-states-in-css-using-state-simulation/)
