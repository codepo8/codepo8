...
- [How to be a more effective developer week (tools and tricks)](https://christianheilmann.com/2020/10/02/how-to-be-a-more-effective-developer-week-tools-and-tricks/)
- [Microsoft Create: Serverless - Developer Hacks and Tools we wished we knew sooner](https://dev.to/azure/microsoft-create-serverless-developer-hacks-and-tools-we-wished-we-knew-sooner-2p30)
<!-- BLOG-POST-LIST:END -->
