...
- [Edge DevTools for Visual Studio Code V2 – new browser preview with emulation and sourcemap support](https://christianheilmann.com/2022/05/05/edge-devtools-for-visual-studio-code-v2-new-browser-preview-with-emulation-and-sourcemap-support/)
- [Edge DevTools for Visual Studio Code V2](https://dev.to/codepo8/edge-devtools-for-visual-studio-code-v2-1bp3)
- [One million broken web sites — and a way to prevent that](https://chrisheilmann.medium.com/one-million-broken-web-sites-and-a-way-to-prevent-that-a97a66625b47?source=rss-2902b181e2e9------2)
<!-- BLOG-POST-LIST:END -->
