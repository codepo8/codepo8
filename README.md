...
- [Cheat codes for the web – Browser developer tools for non-developers](https://dev.to/codepo8/cheat-codes-for-the-web-browser-developer-tools-for-non-developers-1a5j)
- [Cheat codes for the web – Browser developer tools for non-developers](https://christianheilmann.com/2022/08/08/cheat-codes-for-the-web-browser-developer-tools-for-non-developers/)
- [Rethinking Device Emulation in browsers](https://dev.to/codepo8/rethinking-device-emulation-in-browsers-1kbh)
<!-- BLOG-POST-LIST:END -->
