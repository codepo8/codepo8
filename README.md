...
- [One line of CSS to add basic dark/light mode](https://christianheilmann.com/2022/06/20/one-line-of-css-to-add-basic-dark-light-mode/)
- [One line of CSS to add basic dark/light mode](https://dev.to/codepo8/one-line-of-css-to-add-basic-darklight-mode-47o6)
- [GitHub Copilot explaining code and translating it from one language to another](https://christianheilmann.com/2022/06/07/github-copilot-explaining-code-and-translating-it-from-one-language-to-another/)
<!-- BLOG-POST-LIST:END -->
