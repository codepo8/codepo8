...
- [Locking editor panes in Visual Studio Code prevents unwanted multi-tab experiences](https://dev.to/codepo8/locking-editor-panes-in-visual-studio-code-prevents-unwanted-multi-tab-experiences-1a5d)
- [Locking editor panes in Visual Studio Code prevents unwanted multi-tab experiences](https://christianheilmann.com/2021/09/08/locking-editor-panes-in-visual-studio-code-helps-unwanted-multi-tab-experiences/)
- [Using console.log() on any website? Logpoints let you do that!](https://christianheilmann.com/2021/08/24/using-console-log-on-any-website-logpoints-let-you-do-that/)
<!-- BLOG-POST-LIST:END -->
