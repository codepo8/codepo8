...
- [Scratching my own itch: a JavaScript slide show for full screen looping GIFs and MP4s](https://christianheilmann.com/2021/02/25/scratching-my-own-itch-a-javascript-slide-show-for-full-screen-looping-gifs-and-mp4s/)
- [Get all headings and their target URLs from a Markdown generated page](https://dev.to/codepo8/get-all-headings-and-their-target-urls-from-a-markdown-generated-page-5dah)
- [A code snippet to scrape all headings and their target URLs from a markdown generated page](https://christianheilmann.com/2021/02/19/a-code-snippet-to-scrape-all-headings-and-their-target-urls-from-a-markdown-generated-page/)
<!-- BLOG-POST-LIST:END -->
