...
- [Sharing data between CSS and JavaScript using custom properties](https://dev.to/codepo8/sharing-data-between-css-and-javascript-using-custom-properties-5hn5)
<!-- BLOG-POST-LIST:END -->
