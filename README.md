...
- [Edge DevTools for Visual Studio Code 1.4.0 - Improved Screencasting, Device Emulation and live, inline issue reporting](https://dev.to/codepo8/edge-devtools-for-visual-studio-code-140-improved-screencasting-device-emulation-and-live-inline-issue-reporting-1hh)
- [Edge DevTools for Visual Studio Code 1.4.0 – Improved Screencasting, Device Emulation and live, inline issue reporting](https://christianheilmann.com/2021/10/28/edge-devtools-for-visual-studio-code-1-4-0-improved-screencasting-device-emulation-and-live-inline-issue-reporting/)
- [What if… you could use Visual Studio Code as the editor of in-browser Developer Tools?](https://christianheilmann.com/2021/10/12/what-if-you-could-use-visual-studio-code-as-the-editor-of-in-browser-developer-tools/)
<!-- BLOG-POST-LIST:END -->
